...
export default function RaceDetails({ roles }) {
  return (
    <>
      <section className="mb-6">
        ...
        <div className="space-y-4 text-gray-800">
          ...
          <div>
            ...
            <p>
              Become the ultimate champion by winning races, earning reputation points, completing special challenges, and upgrading your vehicles.
            </p>
          </div>
          <div>
            ...
            <ul className="list-disc list-inside">
              <li>
                <strong>Career Mode:</strong> Start from the bottom and work your way up through different racing tiers. Win races, earn reputation points, and unlock new cars and tracks.
              </li>
              <li>
                <strong>Customizable Cars:</strong> Personalize your vehicle with unique paint jobs, decals, and performance upgrades.
              </li>
              <li>
                <strong>Dynamic Weather and Time:</strong> Adapt to races held under varying weather conditions and times of day.
              </li>
              <li>
                <strong>Special Challenges:</strong> Engage in time trials, drift challenges, and escape missions for extra rewards.
              </li>
              <li>
                <strong>Multiplayer Mode:</strong> Compete against friends and racers worldwide in thrilling tournaments.
              </li>
              <li>
                <strong>Open World Exploration:</strong> Discover hidden tracks and side missions between races.
              </li>
              <li>
                <strong>Story Mode:</strong> Experience an engaging narrative with rivalries and unexpected twists.
              </li>
            </ul>
          </div>
          <div>
